/* OFSEP Exam Simulator, Application Logic */

const ACCESS_CODE  = "OFSEP9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 65;
const STORAGE_KEY  = "ofsep_exam_state_v1";
const SIM_Q_COUNT  = 180;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"care_of_the_deceased": "Care of the Deceased", "jurisprudence_and_ontario_law": "Jurisprudence and Ontario Law", "communication_and_responsiveness": "Communication and Responsiveness", "disposition_funeral_services_and_visitation": "Disposition Funeral Services and Visitation", "business_practice": "Business Practice", "professionalism": "Professionalism"};  // maps domain key -> human-readable label for display
